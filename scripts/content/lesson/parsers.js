...
/**
 * Parses data from a Duolingo exercise (or challenge, as it is called in the their codebase).
 * @param {string} type - The type of exercise, e.g., "translate", "match", "tapComplete".
 * @param {Element} wrapper - The DOM element containing the exercise.
 * @returns {Object} An object containing:
 * 	- type: {string} The type of exercise.
 *	- wrapper: {Element} The DOM element containing the exercise.
 *	- question: {string} The main question header.
 *	- content: {Object} The parsed content of the exercise.
 * @example
 * {
 * 		type: "translate",
 * 		wrapper: <HTMLElement>,
